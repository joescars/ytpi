...
# yt-dlp requires deno >= 2.3.0 (see yt_dlp/utils/_jsruntime.py DenoJsRuntime.MIN_SUPPORTED_VERSION) -
# keep this tag at or above that floor or yt-dlp silently falls back to no JS runtime.
